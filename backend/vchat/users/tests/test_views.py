...
class ListUserViewTest(TestCase):
    def setUp(self):
        ...
        self.main_user = User.objects.create_user(username='mainuser', password='password123')
        self.user1 = User.objects.create_user(username='user1', first_name='First', last_name='User')
        self.user2 = User.objects.create_user(username='user2', first_name='Second', last_name='User')
